...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda"):
    ...
    if 'lora' in model_name.lower() and model_base is not None:
        ...
        model = LISAForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True, config=lora_cfg_pretrained, **kwargs)
        ...
        if 'mpt' in model_name.lower():
            ...
            model = LISAForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True, config=cfg_pretrained, **kwargs)
        ...
        model = LISAForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
